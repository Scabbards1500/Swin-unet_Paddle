...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=r'D:\python\MedicalSeg\configs\synapse\swinunet_abdomen_224_224_1_14k_5e-2.yml',
        type=str)
    parser.add_argument(
        '--save_dir',
        dest='save_dir',
        ...
        type=str,
        default=r'D:\python\MedicalSeg\output\abdomen\bestmodelout')
    parser.add_argument(
        '--model_path',
        dest='model_path',
        help='The path of model for export',
        type=str,
        default=r'D:\python\MedicalSeg\output\abdomen\best_model\model.pdparams')
    parser.add_argument(
        '--without_argmax',
        dest='without_argmax',

...
def parse_args():
    ...
    # params of training
    parser.add_argument(
        "--config", dest="cfg", help="The config file.", default='D:\python\MedicalSeg\configs\synapse\swinunet_abdomen_224_224_1_14k_5e-2.yml', type=str)
    parser.add_argument(
        '--iters',
        dest='iters',
    ...
    parser.add_argument(
        ...
        type=str,
        default='D:\python\MedicalSeg\output')
    parser.add_argument(
        '--keep_checkpoint_max',
